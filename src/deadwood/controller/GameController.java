...
/**
 * The GameController class serves as the intermediary between the model and
 * view components,
 * implementing the Observer pattern to notify views of changes to the game
 * state.
 * It encapsulates all game logic that was previously contained in the view
 * classes.
 */
public class GameController {
    ...
    public static class SceneViewModel {
        ...
        public List<RoleViewModel> getStarringRoles() {
            return starringRoles;
        }

        public List<RoleViewModel> getExtraRoles() {
            return extraRoles;
        }
    }
    ...
    public static class BoardViewModel {
        ...
        // Getters
        public List<PlayerTokenViewModel> getPlayerTokens() {
            return playerTokens;
        }

        public List<ShotCounterViewModel> getShotCounters() {
            return shotCounters;
        }
    ...
    public boolean takeRole(String roleName) {
        ...
        if (currentPlayer.getCurrentRole() != null && !currentPlayer.isCurrentRoleCompleted()) {
            System.out.println(
                    "You cannot take a new role while working on an incomplete role. You must act or rehearse.");
            return false;
        }
